...
INDIRECT_CONFIG = Config(file_transmission=FileTransmissionType.INDIRECT,
...
@pytest.mark.parametrize('url, redirect_location', [
    # IIIF Image spec canonicalisation applied to absolute size: 5,5 -> 5,
    ['/imgid/0,0,10,10/5,5/0/default.jpg',
     '/imgid/0,0,10,10/5,/0/default.jpg'],
    ...
    ['/imgid/full/full/1.1000/default.jpg',
     '/imgid/full/full/1.1/default.jpg'],
])
...
@pytest.mark.parametrize('config, url, sendfile_name, sendfile_value', [
    [INDIRECT_CONFIG.merged_with(Config(sendfile_header_name='X-Sendfile')),
     '/imgid/full/full/0/default.jpg', 'X-Sendfile',
     DATA_DIR / 'imgid/full-full-0-default.jpg'],
    [INDIRECT_CONFIG,
     '/imgid/full/full/0/default.jpg', 'X-Accel-Redirect',
     DATA_DIR / 'imgid/full-full-0-default.jpg'],
    [INDIRECT_CONFIG.merged_with(Config(
...
@pytest.mark.parametrize('url, response_body_path', [
