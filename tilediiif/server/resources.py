...
def access_control_allow_all(req: falcon.Request, resp: falcon.Response,
                             resource, params):
...
class IIIFImageMetadataResource:
    ...
    def on_get(self, req: falcon.Request, resp: falcon.Response,
        ...
        try:
            ...
            LOG.warning('rejected info.json request for invalid path; '
...
class IIIFImageResource:
    ...
    @falcon.before(access_control_allow_all)
    def on_get(self, req: falcon.Request, resp: falcon.Response,
               identifier: str, resource: str, size: str, rotation: str,
        ...
        try:
            image_request = IIIFImageRequest.parse(
                region=region, size=size, rotation=rotation, quality=quality,
                format=format)
        except ValueError as e:
        ...
        try:
            image_path = self.get_image_path(identifier,
                                             canonical_image_request)
        except ValueError as e:
            LOG.warning('rejected image request for invalid path; '
                        'identifier=%r, image request=%r cause: %s',
                        identifier, canonical_image_request, e)
            raise falcon.HTTPBadRequest() from e
